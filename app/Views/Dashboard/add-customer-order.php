                            ...
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <input type="text" class="form-control" value="<?= $Searchresult['customer_id']; ?>" readonly="true">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" placeholder="Enter text" value="<?= $Searchresult['title']; ?>" readonly="true">
                                        <!-- <span class="help-block"> A block of help text. </span> -->
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" value="<?= $Searchresult['name']; ?>" readonly="true">
                                        <!-- <span class="help-block"> A block of help text. </span> -->
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" value="<?= $Searchresult['lname']; ?>" readonly="true">
                                        <!-- <span class="help-block"> A block of help text. </span> -->
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" value="<?= $Searchresult['address']; ?>" readonly="true">
                                        <!-- <span class="help-block"> A block of help text. </span> -->
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" value="<?= $Searchresult['add2']; ?>" readonly="true">
                                        <!-- <span class="help-block"> A block of help text. </span> -->
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" value="<?= $Searchresult['city']; ?>" readonly="true">
                                        <!-- <span class="help-block"> A block of help text. </span> -->
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" value="<?= $Searchresult['state']; ?>" readonly="true">
                                        <!-- <span class="help-block"> A block of help text. </span> -->
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" value="<?= $Searchresult['country']; ?>">
                                        <!-- <span class="help-block"> A block of help text. </span> -->
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" value="<?= $Searchresult['zip_code']; ?>">
                                        <!-- <span class="help-block"> A block of help text. </span> -->
                                    </div>
                                </div>
                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a class="btn green" href="<?= base_url('add-orders/'.$Searchresult['customer_id']); ?>" role="button"> Add New
