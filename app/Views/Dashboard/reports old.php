                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="tab2">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group col-sm-4">
                                        <label for="customer_id ">Product sold</label>
                                        <select id="prd2" class="form-control input-medium select2-multiple">
                                            <option></option>
                                    ...
                                    <div class="form-group col-sm-4">
                                        <label for="allotedTo">Agent </label>
                                        <select id="agentName2" class="form-control input-medium select2-multiple">
                                            <option></option>
...
$('#filter-cust').on('submit', function(e) {
